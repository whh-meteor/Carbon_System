    ...
    <div class="cvapage">
        ...
        <el-row :gutter="15">
            <el-col :span="8">
                ...
                <p>摘要：入参TIF数据包含四个：砂、粉砂、粘土和有机碳。计算土壤侵蚀因子K值，输出Tif格式图像。 （调用wms显示全黑的话需要做线性拉伸）</p>
                <el-divider></el-divider>
                <el-collapse v-model="activeNames" accordion>
                    ...
                    <el-collapse-item title="Step2:   输入数据资源 Reference" name="2">
                        ...
                        <el-tabs type="border-card">
                            <el-tab-pane label="引用数据">
                                ...
                                <p>clay</p>
                                <el-input v-model="raster3" placeholder="请输入数据1"></el-input>
                                <p>organic carbon</p>
                                <el-input v-model="raster4" placeholder="请输入数据2"></el-input>
                            </el-tab-pane>
                            <el-tab-pane label="上传数据"> <el-upload class="upload-demo" drag
                    ...
                    <el-collapse-item title="Step3:  发布数据服务 DataService" name="3">
                        ...
                        <br>
                        <el-switch v-model="value2" inactive-text="线性拉伸："></el-switch>
                    </el-collapse-item>
                </el-collapse>
                ...
                <el-tabs v-model="activeName" @tab-click="tabClick">
                    <el-tab-pane label="地图显示" name="first">
                        ...
                        <el-steps :active="2" align-center>
                            <el-step title="数据准备" description=" "></el-step>
                            <el-step title="数据上传" description=" "></el-step>
                            <el-step title="服务执行" description=" "></el-step>
                            <el-step title="结果显示" description=" "></el-step>
                        </el-steps>
                    </el-tab-pane>
...
export default {
    ...
    data() {
        return {
            ...
            activeName: 'first',
            raster1: 'http://192.168.16.192:8085/ILCSData/sand_.tif',
            raster2: 'http://192.168.16.192:8085/ILCSData/silt_.tif',
            raster3: 'http://192.168.16.192:8085/ILCSData/clay_.tif',
            raster4: 'http://192.168.16.192:8085/ILCSData/soc_.tif',
    ...
    methods: {
        ...
        Execute() {
            ...
            var xml = this.MakeIntensityXML('org.n52.wps.server.algorithm.SoilErosionK', this.raster1, this.raster2, this.raster3, this.raster4)
        ...
        MakeIntensityXML(Identifier, urlA, urlB, urlC, urlD) {
            var url = '"' + urlA + '" '
            var url2 = '"' + urlB + '" '
            var url3 = '"' + urlC + '" '
            var url4 = '"' + urlD + '" '
